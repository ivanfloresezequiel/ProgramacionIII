...
class VueloTest {
	...
	// de dar la fecha en Espa�ol. La clase Vuelo debe implementar esa interface
	// El m�todo "fechaHoraSpanish" no es un m�todo "normal" de la clase Vuelo, sino
	// la implementaci�n de un m�todo de interface
	@Test
